...
Espionage.Spy = function() {
  ...
  function findReceivedMethod(obj, method_name) {
    var intercepted_methods = findAllReceivedMethods(obj, method_name);

    if (intercepted_methods) {
      return intercepted_methods[0];
    }
  }
  ...
  var intercepted = function(obj, method_name) {
